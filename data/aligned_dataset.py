...
class AlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):        
        ...
        # assert self.opt.longSize/16 <mask_tensor[0]<self.opt.longSize*15/16
        # assert self.opt.longSize*3/32<mask_tensor[1]<self.opt.longSize*29/32
        # assert self.opt.longSize/16 <mask_tensor[2]<self.opt.longSize*15/16
        # assert self.opt.longSize*3/32<mask_tensor[3]<self.opt.longSize*29/32
        # assert self.opt.longSize*5/32<mask_tensor[4]<self.opt.longSize*27/32
        # assert self.opt.longSize*9/32<mask_tensor[5]<self.opt.longSize*33/32
